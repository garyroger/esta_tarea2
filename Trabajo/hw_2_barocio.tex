...
\author{
\IEEEauthorblockN{Yosniel Agüero\IEEEauthorrefmark{1},
José Reyes\IEEEauthorrefmark{2},
Aylem Velazquez\IEEEauthorrefmark{3},
Gary Sosa\IEEEauthorrefmark{4},
Luis Viera\IEEEauthorrefmark{5}}
\IEEEauthorblockA{\textit{Universidad de Guadalajara, CUCEI} \\
\textit{Maestría en Ciencias en Ingeniería Eléctrica} \\
Guadalajara, Jalisco, México \\
\IEEEauthorrefmark{1}yosniel.aguero9368,
\IEEEauthorrefmark{2}jose.reyes0963,
\IEEEauthorrefmark{3}aylem.velazquez7287,
\IEEEauthorrefmark{4}gary.sosa9369,
\IEEEauthorrefmark{5}luis.viera7283@alumnos.udg.mx}
}
...
\begin{abstract}
	En este trabajo se muestra el procedimiento para obtener los parámetros estándar de un generador síncrono de polos salientes mediante simulaciones de pruebas de rechazo de carga en MATLAB/Simulink. La metodología se fundamenta en las normas IEEE 115 e IEEE 1110, y permite identificar parámetros fundamentales como las reactancias sincrónicas, transitorias y subtransitorias en los ejes directo (d) y en cuadratura (q), así como las constantes de tiempo asociadas en condiciones de circuito abierto y de cortocircuito. Para ello, se implementaron tres pruebas de rechazo de carga: una en el eje directo, una en el eje en cuadratura y una en un eje arbitrario, ajustando las condiciones operativas del generador de manera que la corriente de armadura se alinee con el eje de interés. Durante cada prueba, se registraron las respuestas transitorias de tensión, corriente y excitación, a partir de las cuales se calcularon los valores de las reactancias y las constantes de tiempo características. El estudio confirma que el análisis de los ejes $d$ y $q$ proporciona un marco completo para describir el comportamiento dinámico del generador, permitiendo representar de manera precisa la interacción entre el flujo del rotor y las corrientes de armadura bajo diferentes condiciones de operación.
\end{abstract}
...
Este trabajo describe el procedimiento para obtener los parámetros estándar del generador síncrono de polos salientes. Este tipo de máquina, una de las dos categorías principales de generadores síncronos, es idónea para centrales hidroeléctricas, donde las turbinas suelen operar a bajas velocidades de rotación. Su diseño con un rotor de polos salientes permite una generación eficiente de flujo magnético incluso a regímenes tan bajos como $50\text{ a } 300\text{ rpm}$.
